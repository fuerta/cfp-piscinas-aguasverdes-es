    ...
    <section className="py-24 lg:py-32 px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative aspect-[16/9] lg:aspect-[21/9] w-full rounded-2xl overflow-hidden bg-secondary/50 border border-border/50">
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d671.014186440514!2d-14.094845175622387!3d28.48623429830461!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xc47bb2a67d30dc5%3A0xa67851ba1938a873!2sAguas%20Verdes!5e0!3m2!1sen!2suk!4v1774200769017!5m2!1sen!2suk"
            width="100%"
            height="450"
            style={{ border: 0 }}
            allowFullScreen=""
